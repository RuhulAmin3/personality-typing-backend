...
const createCharacter = catchAsync(
    async (req, res) => {
...
const getAllCharacter = catchAsync(
    async (req, res) => {
...
const deleteCharacter = catchAsync(
    async (req, res) => {
        const { id } = req.params;
...
const getSingleCharacter = catchAsync(
    async (req, res) => {
        const { id } = req.params;
...
const updateCharacter = catchAsync(
    async (req, res) => {
        const { id } = req.params;
        const data = req.body;
