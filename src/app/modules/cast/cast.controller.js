...
const getAllCast = catchAsync(
    async (req, res) => {
        const result = await castService.getAllCast();
        sendResponse(res, {
...
const deleteCastWithCharacters = catchAsync(
    async (req, res) => {
        const { id } = req.params;
